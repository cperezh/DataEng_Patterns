-- Recrea la tabla movimientos: DROP + CREATE
BEGIN;
...
COMMENT ON TABLE movimientos IS 'Tabla que almacena los movimientos de cuenta (esquema actualizado para usar "comentario" en lugar de "concepto")';
